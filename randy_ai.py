...
# You can also use the functions in utilities to write your AI
# from utilities import find_lines, get_possible_moves
from utilities import get_possible_moves
...
def run_ai():
    ...
    # We read the color: 1 for dark (goes first), 2 for light.
